...
urlpatterns = [
    ...
    url(r'^asset_hand_add_security_device.html$', asset_view.asset_hand_add_security_device, name='asset_hand_add_security_device'),
    ...
    url(r'^asset_export.html', asset_view.asset_export, name='asset_export'),
    # IDC
    ...
    url(r'^dashboard_chart3.html', dashboard_view.chart3, name='chart3'),
]
