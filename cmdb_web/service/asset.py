...
class Asset(BaseServiceList):
    def __init__(self):
        ...
        # 额外的查询
        extra_select = {
            'hostname': 'select hostname from cmdb_data_hardwareserver where cmdb_data_hardwareserver.asset_id=cmdb_data_asset.id union all select hostname from cmdb_data_softwareserver where cmdb_data_softwareserver.asset_id=cmdb_data_asset.id union all select device_name from cmdb_data_networkdevice where cmdb_data_networkdevice.asset_id=cmdb_data_asset.id union all select device_name from cmdb_data_securitydevice where cmdb_data_securitydevice.asset_id=cmdb_data_asset.id',
            'sn': 'select sn from cmdb_data_hardwareserver where cmdb_data_hardwareserver.asset_id=cmdb_data_asset.id union all select sn from cmdb_data_networkdevice where cmdb_data_networkdevice.asset_id=cmdb_data_asset.id union all select sn from cmdb_data_securitydevice where cmdb_data_securitydevice.asset_id=cmdb_data_asset.id'
        }
